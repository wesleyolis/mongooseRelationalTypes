...
//     TDefault extends _Default,
//     TRefType extends _RefType
//     >(shape : TShape, type : TypesPrimative) : IModifiersFunWithConstraints<TAvaliableOptions, TShape, TRequired, TReadonly, TNullable, TDefault, TRefType>
//     {
//         return new Modifiers<TAvaliableOptions, TShape, 'Op', 'Set', 'Value', undefined, undefined>
//         (shape, type, 'Op', 'Set', 'Value', undefined, undefined, undefined) as any;
//     }
